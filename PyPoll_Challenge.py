...
# 2: Track the winning county, winning county vote count and winning county percentage.
winning_county = ""
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        # Determine county winning vote count, county winning percentage, and county winner
        ...
        winning_county_summary = (
            ...
            f"County Winning Vote Count: {winning_county_count:,}\n"
            f"County Winning Percentage: {winning_county_percentage:.1f}%\n"
            f"-------------------------\n")
